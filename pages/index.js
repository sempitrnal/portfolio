		...
		<motion.div className="min-h-screen ease-in-out dark:text-white page">
			...
			>
				<div className="flex flex-col items-center justify-between gap-10 lg:items-end lg:flex-row">
					...
					<div className="hidden w-[15rem] h-[15rem] overflow-hidden rounded-full  lg:block relative lg:w-[22rem] lg:h-[22rem]">
						<Image
							src={"/bo.png"}
							layout="fill"
							objectFit="contain"
				...
				<motion.p className="paragraph">
					...
					<span className="font-semibold"> Software Development. </span>I aspire
					to be a full-stack developer who can adapt quickly and easily grasp
					emerging technologies.
				</motion.p>
				<p className="paragraph">
					...
					<span className="font-semibold">React Native </span> as my main Mobile
					App Tech Stack.
				</p>
				<p className="paragraph">
					Other than coding, I enjoy doing{" "}
					...
					<span className="font-semibold">musical instruments</span> in my free
					time.
				</p>

				<h2 className="header2">Stack</h2>
				<div className="flex flex-wrap w-full gap-6 my-10 mb-24">
					{tech_stack.map((e) => {
